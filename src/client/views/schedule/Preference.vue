  ...
  <div class="p-4">
    ...
    <el-form ref="formRef" :model="form" :rules="rules" label-width="120px" class="max-w-2xl">
      ...
      <el-form-item label="工作日偏好" prop="workday_pref">
        <el-select v-model="form.workday_pref" multiple placeholder="请选择可工作的日期">
      ...
      <el-form-item label="时间段偏好" prop="time_pref">
        <el-time-picker
          v-model="form.time_pref" is-range range-separator="至" start-placeholder="开始时间"
          end-placeholder="结束时间" format="HH:mm"
        />
      </el-form-item>

      <el-form-item label="最大日工时" prop="max_daily_hours">
        <el-input-number v-model="form.max_daily_hours" :min="0" :max="24" placeholder="请输入最大日工作时长" />
      </el-form-item>

      <el-form-item label="最大周工时" prop="max_weekly_hours">
        <el-input-number v-model="form.max_weekly_hours" :min="0" :max="168" placeholder="请输入最大周工作时长" />
      </el-form-item>
